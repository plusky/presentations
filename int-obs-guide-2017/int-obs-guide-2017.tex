...
\begin{frame}[t]{What is buildservice}
    ...
    \begin{itemize}
      ...
      \item Automatic rebuilds when dependency tree changes (i.e Factory)
      \item Reproducible builds
      \item See i.e \url{https://build.opensuse.org/package/show/benchmark/glmark2}
    \end{itemize}
...
\begin{frame}{openSUSE Tumbleweed}
  ...
  \center{\url{https://build.opensuse.org/project/dashboard/openSUSE:Factory}}
\end{frame}
...
\begin{frame}{examples}
	\center{Default view \url{http://build.opensuse.org}}
	\center{Factory requests \url{https://build.opensuse.org/project/requests/openSUSE:Factory}}
	\center{Devel project \url{https://build.opensuse.org/project/show/server:database}}
	\center{Incidents \url{https://build.opensuse.org/project/maintenance_incidents/openSUSE:Maintenance}}
\end{frame}
