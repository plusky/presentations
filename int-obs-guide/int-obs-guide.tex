...
\begin{frame}[t]{Build tool}
    \begin{itemize}
      ...
      \item \url{https://build.opensuse.org/monitor}
      \item Does all basic operators: scheduler, signer, dispatcher, etc.
...
\begin{frame}[t]{VCS}
    \begin{itemize}
      \item Builtin version control system quite similar to mercurial
